...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Repository.Entities.AiAnalysisHistory", b =>
                {
                    ...
                    b.ToTable("AiAnalysisHistories", (string)null);
                });
            ...
            modelBuilder.Entity("Repository.Entities.AnalysisJobRerunAudit", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.ToTable("analysis_job_rerun_audits", (string)null);
                });
            ...
            modelBuilder.Entity("Repository.Entities.ChapterChunk", b =>
                {
                    ...
                    b.ToTable("ChapterChunks", (string)null);
                });
            ...
            modelBuilder.Entity("Repository.Entities.ChapterVersion", b =>
                {
                    ...
                    b.ToTable("ChapterVersions", (string)null);
                });
            ...
            modelBuilder.Entity("Repository.Entities.Faq", b =>
                {
                    ...
                    b.HasIndex("Category", "Published", "Order");
            ...
            modelBuilder.Entity("Repository.Entities.ProjectAbuseFlag", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.ToTable("ProjectAbuseFlags", null, t =>
                        {
                            t.HasCheckConstraint("CK_ProjectAbuseFlags_Severity", "\"Severity\" IN ('Warning','Critical')");
                        });
                });

            modelBuilder.Entity("Repository.Entities.ProjectAnalysisFact", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.ToTable("ProjectAnalysisFacts", (string)null);
                });
            ...
            modelBuilder.Entity("Repository.Entities.ProjectAnalysisJob", b =>
                {
                    ...
                    b.ToTable("ProjectAnalysisJobs", null, t =>
                        {
            ...
            modelBuilder.Entity("Repository.Entities.ProjectGenre", b =>
                {
                    ...
                    b.ToTable("ProjectGenres", (string)null);
                });
            ...
            modelBuilder.Entity("Repository.Entities.ProjectReport", b =>
                {
                    ...
                    b.Property<string>("GenresSnapshot")
                        .HasColumnType("jsonb");
                    ...
                    b.Property<string>("StaffEditedCriteriaJson")
                        .HasColumnType("text");
                    ...
                    b.ToTable("ProjectReports", null, t =>
                        {
            ...
            modelBuilder.Entity("Repository.Entities.ProjectReportSnapshot", b =>
                {
                    ...
                    b.ToTable("ProjectReportSnapshots", (string)null);
                });
            ...
            modelBuilder.Entity("Repository.Entities.ReportCharacterEntry", b =>
                {
                    ...
                    b.ToTable("ReportCharacterEntries", (string)null);
                });
            ...
            modelBuilder.Entity("Repository.Entities.ReportThemeEntry", b =>
                {
                    ...
                    b.ToTable("ReportThemeEntries", (string)null);
                });
            ...
            modelBuilder.Entity("Repository.Entities.ReportTimelineEvent", b =>
                {
                    ...
                    b.ToTable("ReportTimelineEvents", (string)null);
                });
            ...
            modelBuilder.Entity("Repository.Entities.ReportWorldbuildingEntry", b =>
                {
                    ...
                    b.ToTable("ReportWorldbuildingEntries", (string)null);
                });
            ...
            modelBuilder.Entity("Repository.Entities.StaffAnalysisReview", b =>
                {
                    ...
                    b.HasIndex("RerunReportId");

                    b.HasIndex("ReviewedBy");

                    b.ToTable("StaffAnalysisReviews", null, t =>
                        {
                            t.HasCheckConstraint("CK_StaffAnalysisReview_Action", "\"Action\" IN ('Verified','Adjusted','RerunRequested')");
                        });
                });

            modelBuilder.Entity("Repository.Entities.StaffFeedback", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.ToTable("StaffFeedbacks", null, t =>
                        {
                            t.HasCheckConstraint("CK_StaffFeedback_Status", "\"Status\" IN ('Open','Resolved')");
                        });
                });
            ...
            modelBuilder.Entity("Repository.Entities.StaffGenre", b =>
                {
                    ...
                    b.ToTable("StaffGenres", (string)null);
                });
            ...
            modelBuilder.Entity("Repository.Entities.SystemLog", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Repository.Entities.User", b =>
                {
                    ...
                    b.Property<string>("BanRequestReason")
                        .HasColumnType("text");

                    b.Property<Guid?>("BanRequestedBy")
                        .HasColumnType("uuid");
                    ...
                    b.Property<bool>("IsBanRequested")
                        .HasColumnType("boolean");
            ...
            modelBuilder.Entity("Repository.Entities.WritingTip", b =>
                {
                    ...
                    b.ToTable("writing_tips", (string)null);
                });
            ...
            modelBuilder.Entity("Repository.Entities.ProjectAnalysisFact", b =>
                {
                    ...
                    b.HasOne("Repository.Entities.ProjectAnalysisJob", "AnalysisJob")
                        .WithMany()
                        .HasForeignKey("RunId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Repository.Entities.StaffAnalysisReview", b =>
                {
                    ...
                    b.HasOne("Repository.Entities.ProjectReport", "RerunReport")
                        .WithMany()
                        .HasForeignKey("RerunReportId")
                        .OnDelete(DeleteBehavior.SetNull);
            ...
            modelBuilder.Entity("Repository.Entities.SystemLog", b =>
                {
                    b.HasOne("Repository.Entities.User", "Actor")
                        .WithMany()
            ...
            modelBuilder.Entity("Repository.Entities.UserSubscription", b =>
                {
                    b.HasOne("Repository.Entities.SubscriptionPlan", "NextPlan")
                        .WithMany()
