-- Nội dung FAQ & Writing Tip mặc định (published). Chạy trên Supabase khi cần cập nhật / bổ sung.
-- An toàn: UPSERT theo Id cố định.
...
('a1000001-0001-4001-8001-000000000005', 'Rewrite, Viết mới và Tiếp nối khác nhau thế nào?',
 E'• Rewrite: chọn đoạn văn, đưa instruction (ví dụ "ngắn gọn hơn", "thêm căng thẳng").\n• Viết mới: AI soạn từ dàn ý bạn nhập.\n• Tiếp nối: AI viết tiếp từ đoạn cuối chương, bám mạch truyện hiện có.\nCả ba đều dùng ngữ cảnh dự án và trừ token gói của bạn.',
 'AI & RAG', 4, TRUE, NOW()),
...
('a1000001-0001-4001-8001-000000000012', 'Tôi báo lỗi ứng dụng ở đâu?',
 'Tác giả: widget Báo cáo lỗi trên sidebar — mô tả lỗi và bước tái hiện. Phản hồi từ Staff xem tại Feedback. Staff/Admin xử lý ticket tại Báo cáo lỗi app.',
 'Hỗ trợ', 11, TRUE, NOW()),
